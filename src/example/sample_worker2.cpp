...
int main(int argc, char* argv[]) {
    ...
    afs::InThreadNet<DummyType>* i_thread =
        new afs::InThreadNet<DummyType>(in_callback, NULL);
    ...
    for (int i=0; i<num_analyzer; i++) {
        ...
        AnalyzerThread2* analyzer =
            new AnalyzerThread2(num_downstream, router_tmp);
