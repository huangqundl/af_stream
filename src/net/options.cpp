...
int afs_zmq::options_t::setsockopt (int option_, const void *optval_,
    size_t optvallen_)
{
...
int afs_zmq::options_t::getsockopt (int option_, void *optval_, size_t *optvallen_)
{
    bool is_int = (*optvallen_ == sizeof (int));
