...
afs_zmq::null_mechanism_t::null_mechanism_t (
...
int afs_zmq::null_mechanism_t::next_handshake_command (msg_t *msg_)
{
...
int afs_zmq::null_mechanism_t::process_handshake_command (msg_t *msg_)
{
...
int afs_zmq::null_mechanism_t::zap_msg_available ()
{
    /*
...
bool afs_zmq::null_mechanism_t::is_handshake_complete () const
{
