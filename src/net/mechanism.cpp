...
afs_zmq::mechanism_t::mechanism_t (const options_t &options_) :
    options (options_)
{
}

afs_zmq::mechanism_t::~mechanism_t ()
{
}

void afs_zmq::mechanism_t::set_peer_identity (const void *id_ptr, size_t id_size)
{
    identity = blob_t (static_cast <const unsigned char*> (id_ptr), id_size);
}

void afs_zmq::mechanism_t::peer_identity (msg_t *msg_)
{
...
const char *afs_zmq::mechanism_t::socket_type_string (int socket_type) const
{
...
size_t afs_zmq::mechanism_t::add_property (unsigned char *ptr, const char *name,
...
int afs_zmq::mechanism_t::parse_metadata (const unsigned char *ptr_,
                                      size_t length_)
{
...
int afs_zmq::mechanism_t::property (const std::string name_,
...
bool afs_zmq::mechanism_t::check_socket_type (const std::string type_) const
{
    switch (options.type) {
        case ZMQ_REQ:
