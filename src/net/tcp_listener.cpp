...
// qhuang
void zmq::tcp_listener_t::set_poller (epoll_t* poller)
{
...
bool zmq::tcp_listener_t::in_event ()
{
    char peer_addr[16];
    ...
    zmq::stream_engine_t *engine = new (std::nothrow)
        zmq::stream_engine_t (fd, options, endpoint, in_callback_, out_callback);
    alloc_assert (engine);
...
zmq::fd_t zmq::tcp_listener_t::accept (char* peer_addr)
{
