 ...
 * @tparam T output class of dispatcher, used for input of analyzers in the same worker
 */
//template <class T>
class OutThreadMPSC : public OutThread {
...
public:
    ...
    OutThreadMPSC(int num_in, int num_out) :
        OutThread(), num_in_(num_in), num_out_(num_out) {
