#ifndef __ROLL_IN_CALLBACK_SIMPLE_HPP_INCLUDED__
#define __ROLL_IN_CALLBACK_SIMPLE_HPP_INCLUDED__
...
public:
    int PushRecord(void* data, uint32_t len, zmq::i_engine* engine);
...
template<class T>
int InCallbackSimple<T>::PushRecord(void* data, uint32_t len, zmq::i_engine* engine) {
