 ...
 */
template <class InT>
class InThreadTraceUpbackup : public InThread<InT, NullClass> {

typedef WrapItem<InT> WInT;

public:
    InThreadTraceUpbackup(int num_analyzer, RouterBase* router);
...
template<class InT>
InThreadTraceUpbackup<InT>::InThreadTraceUpbackup(
        int num_analyzer,
        RouterBase* router
        ) :
...
template<class T>
void InThreadTraceUpbackup<T>::AddOutQueue(ZeroRingBuffer<WInT>* q) {
    queues_.push_back(q);
}

template<class T>
void InThreadTraceUpbackup<T>::ThreadInitHandler() {
...
template<class T>
void InThreadTraceUpbackup<T>::ThreadMainHandler() {
    LOG_MSG("InThreadTraceUpbackup (%d) start to run\n", getpid());
...
template<class T>
void InThreadTraceUpbackup<T>::ThreadFinishHandler() {
