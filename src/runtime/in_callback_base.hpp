#ifndef __ROLL_IN_CALLBACK_BASE_HPP_INCLUDED__
#define __ROLL_IN_CALLBACK_BASE_HPP_INCLUDED__
...
public:
    virtual int PushRecord(void* data, uint32_t len, zmq::i_engine* engine=NULL) = 0;
    virtual void Init() {}
    virtual void Clean() {}
