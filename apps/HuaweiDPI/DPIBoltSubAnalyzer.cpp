...
void DPIBoltSubComputeThread::finish()
{
    ...
    SubComputeThread<Packet::TotalField, Packet::TotalField>::finish();
}

DPIBoltSubComputeThread::DPIBoltSubComputeThread(std::string name, int id) :
    SubComputeThread<Packet::TotalField, Packet::TotalField>(name, id)
{
...
void DPIBoltSubComputeThread::initialize()
{
    ...
    SubComputeThread <Packet::TotalField, Packet::TotalField >::initialize();
}
