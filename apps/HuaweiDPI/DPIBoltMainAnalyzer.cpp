...
void DPIBoltMainComputeThread::finish() {
    ...
    printf("===================================================\n");
    MainComputeThread<Packet::TotalField, Dummy>::finish();
}

/****************************************************************************
 * Public functions
 ****************************************************************************/
DPIBoltMainComputeThread::DPIBoltMainComputeThread(std::string name, int num): MainComputeThread<Packet::TotalField, Dummy>(name, num) {
    tot_packet_count = 0;
...
void DPIBoltMainComputeThread::initialize() {
    ...
    MainComputeThread<Packet::TotalField, Dummy>::initialize();
}
