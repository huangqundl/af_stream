#ifndef __PacketTokenGroupingMigrateFB_hpp__
#define __PacketTokenGroupingMigrateFB_hpp__
...
class PacketTokenGroupingMigrateFB : public LoadBalancer <Packet::BasicField> {
private:
    typedef struct {
        // key
...
public:
    PacketTokenGroupingMigrateFB() {
        LOG_MSG("LoadBalancer in ZMQMainAnalyzer: PacketTokenGroupingMigrateFB\n");
 ...
 ****************************************************************************/
unsigned int 
PacketTokenGroupingMigrateFB::flow_hash_fcn(const HASH_FLOW* f) {
    char key[7];
...
bool 
PacketTokenGroupingMigrateFB::flow_cmp_fcn(const HASH_FLOW* f1, const HASH_FLOW* f2) {
...
void 
PacketTokenGroupingMigrateFB::flow_init_fcn(HASH_FLOW* f, void* st_arg) {
    memset(f, 0, sizeof(HASH_FLOW));
}

void 
PacketTokenGroupingMigrateFB::flow_free_fcn(HASH_FLOW* f, void* st_arg) {
    memset(f, 0, sizeof(HASH_FLOW));
}

void 
PacketTokenGroupingMigrateFB::flow_travel_do_fcn(HASH_FLOW* f, void* context) {
    if (f->rebalance_time) {
