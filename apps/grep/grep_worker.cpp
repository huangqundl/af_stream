...
#include "grep_compute_thread.hpp"
#include "grep_compute_thread_minibatch.hpp"
#include "grep_compute_thread_upbackup.hpp"
...
int main(int argc, char* argv[]) {
    ...
    for (int i=0; i<num_compute_thread; i++) {
        ...
        if (strcmp(in_type, "UpThread")==0
            ...
            compute_thread = new ComputeThreadThread(0, NULL);
        }
        else if (strcmp(in_type, "UpThreadMinibatch")==0) {
